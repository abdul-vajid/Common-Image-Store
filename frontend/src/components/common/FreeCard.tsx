...
export const FreeCard: React.FC = () => {
    return (
        <Card color="gray" variant="gradient" className="w-full max-w-[20rem] px-8 pt-5 pb-4 md:px-8 md:pt-8 md:pb-8">
            <CardHeader
                floated={false}
                shadow={false}
                color="transparent"
            ...
            >
                ...
                >
                    <span className="mt-2 text-xl md:text-4xl">$</span>0{" "}
            ...
            <CardBody className="p-0">
                <ul className="flex flex-col gap-4">
                    <li className="flex items-center gap-4">
                        ...
                        <Typography className="font-normal line-through">Upload multiple images</Typography>
                    </li>
                    <li className="flex items-center gap-4">
                        <span className="rounded-full border border-white/20 bg-white/20 p-1">
                            <CrossIcon />
                        </span>
                        <Typography className="font-normal line-through">No time based limits</Typography>
                    </li>
                    <li className="flex items-center gap-4">
                        <span className="rounded-full border border-white/20 bg-white/20 p-1">
                            <CheckIcon />
