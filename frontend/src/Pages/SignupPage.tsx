...
import { setAllErrorsEmpty, userSignup } from '../redux/reducers/userSlice';
import axiosInstance from '../app/config/apiConfig';
import { useErrorToast } from '../app/hooks/toastHooks';

export const SignupPage: React.FC = () => {
    const dispatch = useAppDispatch()
    const { signupError, signupLoading } = useAppSelector(state => state.userReducer)
    ...
    useEffect(() => {
        if (signupError) {
            useErrorToast({ message: signupError })
            setTimeout(() => {
                        ...
                        <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
                            <div className="mb-4 flex flex-col gap-6">
                                <div>
                                    ...
                                    />
                                    {
                                        formik.errors.fullname && <Typography
                                            variant="small"
                                            color="gray"
                                        ...
                                        >
                                            ...
                                            {formik.errors.fullname || "Invalid fullname"}
                                        </Typography>
                                    }
                                </div>
                                <div>
